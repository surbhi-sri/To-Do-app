    ...
    <>
      ...
      <div className="mx=3 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-[38%]">
        ...
        <div className="addTodo my-5 flex flex-col gap-4">
          ...
          <div className="flex">
            <input onChange={handleChange} value={todo} type="text" className='w-full rounded-3xl px-3 py-1' placeholder=' Add your todos___' />

            <button onClick={handleAdd} disabled={todo.length <= 3} className="bg-violet-800 hover:bg-violet-950 cursor-pointer disabled:bg-violet-500 p-4 py-2 mx-2  text-sm font-bold text-white rounded-full ">Save</button>
          </div>

        </div>

        <input className='my-4' id='show' onChange={toggleFinished} type="checkbox" checked={showFinished} />
        <label className='mx-2' htmlFor="show"> Show Finshed</label>
